...
#### 1_1. 설명문인 이름에 정보를 담아내는 방법 1/3
보편적인 단어를 피하고 구체적인 단어를 선택하는 방법이 있습니다.
- get => fetch, download
- find => search, extract, locate
- start => launch, create, open, begin
- make => create, build, generate
- 구체적인 목적을 설명해주는 것이 좋습니다.

#### 1_2. 설명문인 이름에 정보를 담아내는 방법 2/3
- 시간의 양이나 바이트의 수와 같이 측정치를 포함하면
- 단위를 포함하는 것이 좋습니다.
```js
// Not Cool
const currentTime = new Date().getTime()
console.log(`Current Seconds is ${currentTime}`)

// Cool
const currentTimeMs  = new Date().getTime()
console.log(`Current Seconds is ${currentTimeMs}`)
```

#### 1_3. 설명문인 이름에 정보를 담아내는 방법 3/3
- 위험한 요소가 있다면 표현합니다.
  - 패스워드가 암호화 안되있다면 : password => plainTextPassword
  - URL Encoded 데이터라면 : data => dataURLEncoded

#### 1_4. 마지막, 오해하지 않게 이름 짓기
- 다른 사람들은 다른의미로 해석할 수도 있음
- **다른 사람들은 다른 의미로 해석할 수 있을까?** 질문을 던져 확인하는 게 좋음
