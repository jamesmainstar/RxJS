...
- 어디에서 가져오는 지, 무엇을 반환하는 지, 무엇을 수행하는 지
...
#### 1_3. 다른 중요한 속성 포함하기
위험함 요소 혹은 나중에 잘못 이해했을 때, 심각한 버그를 만들 가능성 있는 것들을 위험 요소를 포함하는 것이 좋다.
...
- 다행히도 표현하는 많은 부분이 동일하다.
- 따라서 동일한 부분을 요약 변수로 추출해서 함수의 앞부분에 놓아둘 수 있다.
